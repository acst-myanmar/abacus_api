...
class TestingController extends Controller
{
    ...
    public function generateDMQ(QuestionRequest $request)
    {
        try{
    ...
    public function generateLFQ(QuestionRequest $request)
    {
        try{
            $first_num = rand(0, 9);
    ...
    public function generateBFQ(QuestionRequest $request)
    {
        try{
            $firstNum = rand(1,99);
